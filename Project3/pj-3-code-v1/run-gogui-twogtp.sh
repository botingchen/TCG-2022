...
P1B='./nogo --shell --name="Hollow-Black" --black="search=MCTS seed=12345 simulation=8000"'
P1W='./nogo --shell --name="Hollow-White" --white="search=MCTS seed=12345 simulation=8000"'
# commands for local player 2
P2B='./nogo-judge --shell --name="Judge-Weak-Black" --black="strong"'
P2W='./nogo-judge --shell --name="Judge-Weak-White" --white="srtong"'
